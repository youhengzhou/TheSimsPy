...
class Soldier(Role):
    roleData = {
        "type": "soldier",
        "archetype": ["infantry", "skirmisher", "cavalry", "frontier guard"],
        "events": {
...
class Monk(Role):
    roleData = {
        "type": "monk",
        "archetype": ["redemption", "spirituality", "misanthropy", "knowledge"],
        "events": {
...
class Priest(Role):
    roleData = {
        "type": "priest",
        "archetype": ["local", "imperial", "lyonian orthodoxy", "tigian orthodoxy"],
        "events": {
...
class Citizen(Role):
    roleData = {
        "type": "citizen",
        "archetype": ["shop", "service", "inn", "worker"],
        "events": {
...
class Thug(Role):
    roleData = {
        "type": "thug",
        "archetype": ["ivory fangs", "the spankers", "mad bastards", "smiling fellas"],
        "events": {
